...
def get_reference(URL):
    driver = webdriver.Chrome('C:/Users/LeeSeunghoon/Desktop/Work/python/natural-language-processing/chromedriver')
    driver.get(URL)
    ...
    reference_data = pd.DataFrame({'저자': [author], '국문 제목': [title_kor], '영문 제목': [title_eng], '수록지': [book], '핵심어': [keyword], '국문 요약': [txt_kor], '영문 요약': [txt_eng], '링크': [URL]})
